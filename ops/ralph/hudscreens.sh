...
# renders the plates with a plain QML engine into a 300x560 rectangle: the
...
# at all while nothing changes — quiet, with a plate on screen, and with
# a plate on screen while a frame arrives every second (A34/A42).
